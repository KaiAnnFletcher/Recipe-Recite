...
(function (Constants) {
     ...
     */
    Constants.ToChannelFromBotLoginUrlPrefix = 'https://login.microsoftonline.com/';
    /**
     * TO CHANNEL FROM BOT: Login URL token endpoint path
     */
    Constants.ToChannelFromBotTokenEndpointPath = '/oauth2/v2.0/token';
    /**
     * TO CHANNEL FROM BOT: Default tenant from which to obtain a token for bot to channel communication
     */
    Constants.DefaultChannelAuthTenant = 'botframework.com';
    /**
