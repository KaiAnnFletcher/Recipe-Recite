...
class MicrosoftAppCredentials {
    constructor(appId, appPassword, channelAuthTenant) {
        ...
        const tenant = channelAuthTenant && channelAuthTenant.length > 0
            ? channelAuthTenant
            : constants_1.Constants.DefaultChannelAuthTenant;
        this.oAuthEndpoint = constants_1.Constants.ToChannelFromBotLoginUrlPrefix + tenant + constants_1.Constants.ToChannelFromBotTokenEndpointPath;
